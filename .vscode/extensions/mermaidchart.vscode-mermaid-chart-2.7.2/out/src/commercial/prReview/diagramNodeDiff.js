...
exports.findNodeLineRanges = exports.buildChangeList = exports.diffNodes = exports.formatDiffCountSummary = exports.summarizeNodeDiff = exports.extractNodeIds = void 0;
...
exports.formatDiffCountSummary = formatDiffCountSummary;
/**
 ...
 */
function diffNodes(oldSource, newSource) {
 ...
 */
function buildChangeList(oldSource, newSource, diff) {
 ...
 */
function extractNodeDeclarations(source) {
    const decls = new Map();
    const withoutFrontmatter = stripFrontMatter(source);
    for (const rawLine of withoutFrontmatter.split(/\r?\n/)) {
        const line = rawLine.trim();
...
function findNodeLineRanges(source, nodeId) {
    if (!nodeId.trim()) {
        return [];
    }
...
exports.findNodeLineRanges = findNodeLineRanges;
 ...
 */
function stripLabelContent(line) {
...
//# sourceMappingURL=diagramNodeDiff.js.map