...
exports.generateAuthOptionsContent = void 0;
const vscode = __importStar(require("vscode"));
function generateAuthOptionsContent(webview, extensionUri) {
    const logoSrc = webview.asWebviewUri(vscode.Uri.joinPath(extensionUri, "images", "panel.svg"));
    const fontUrl = webview.asWebviewUri(vscode.Uri.joinPath(extensionUri, "media", "recursive-latin-full-normal.woff2"));
    return `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
exports.generateAuthOptionsContent = generateAuthOptionsContent;
//# sourceMappingURL=authOptionsTemplate.js.map