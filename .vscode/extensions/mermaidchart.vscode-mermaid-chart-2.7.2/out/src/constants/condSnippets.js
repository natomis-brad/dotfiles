...
exports.getSnippetsBasedOnDiagram = void 0;
const snippets = [
    {
        id: "mmflrect",
        diagram: "flowchart",
  ...
  `,
    ...
    },
    {
        ...
        section: "other",
        name: "Highlight",
        completion: "rect rgb(191, 223, 255)\n    ${1:From} ->> ${2:To}:${3:Message text}\nend\n$0",
  ...
  option Another action
    ...
    },
    {
        ...
        section: "other",
        name: "Break",
        completion: "break ${1:Some reason} \n  ${2:From} ->> ${3:To}:${4:Message text}\nend\n$0",
...
const getSnippetsBasedOnDiagram = (languageId) => {
...
exports.getSnippetsBasedOnDiagram = getSnippetsBasedOnDiagram;
//# sourceMappingURL=condSnippets.js.map