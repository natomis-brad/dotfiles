...
exports.getIconColor = exports.getThemeColors = exports.VSCODE_THEME_MAPPING = void 0;
/**
 * Maps VS Code theme IDs to our internal theme names
 */
exports.VSCODE_THEME_MAPPING = {
    // Dark themes
    'Default Dark+': {
 ...
 */
function getThemeColors(vscodeThemeName) {
    if (exports.VSCODE_THEME_MAPPING[vscodeThemeName]) {
        return exports.VSCODE_THEME_MAPPING[vscodeThemeName];
    }
    return exports.VSCODE_THEME_MAPPING['Default Dark+'];
}
exports.getThemeColors = getThemeColors;
/**
 * Icon / control foreground: white on dark diagram canvas, VS Code accent on light diagram canvas.
 */
function getIconColor(diagramTheme, vscodeAccentColor) {
