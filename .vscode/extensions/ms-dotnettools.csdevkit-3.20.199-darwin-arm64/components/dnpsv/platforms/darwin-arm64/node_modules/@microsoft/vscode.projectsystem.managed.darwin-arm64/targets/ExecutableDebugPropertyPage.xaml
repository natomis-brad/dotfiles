...
<Rule Name="ExecutableDebugPropertyPage"
  ...
  <EnumProperty Name="DebugEngines"
                DisplayName="Debug engines"
                Description="Select the debugging engine(s) to use when launching.">
    <EnumValue Name="managed" DisplayName="Managed (automatic)" />
    <EnumValue Name="managed,native" DisplayName="Managed (automatic) with native" />
    <EnumValue Name="managed-dotnet" DisplayName="Managed (.NET Core / .NET 5+)" />
    <EnumValue Name="managed-dotnet,native" DisplayName="Managed (.NET Core / .NET 5+) with native" />
    <EnumValue Name="managed-framework" DisplayName="Managed (.NET Framework)" />
    <EnumValue Name="managed-framework,native" DisplayName="Managed (.NET Framework) with native" />
    <EnumValue Name="native" DisplayName="Native only" />
  </EnumProperty>
