...
<Project xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  ...
  <!--Whether HotReload should be enabled or not-->
  <ItemGroup>
    <ProjectCapability
        Include="HotReloadEnabled"
        Condition=" '$(DebugSymbols)' == 'true' and
                    '$(Optimize)' != 'true' and
                    '$(TargetFramework)' != '' and
                    ('$(StartupHookSupport)' != 'false' or '$(UsingMicrosoftNETSdkBlazorWebAssembly)' == 'true') " />
  </ItemGroup>
